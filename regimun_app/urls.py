...
urlpatterns = patterns('',
    # conferences index
    (r'^$', ListView.as_view(queryset=conferences,template_name='conference_list.html')),
...
# conference index
    (r'^(?P<slug>[-\w]+)/$', DetailView.as_view(queryset=conferences, slug_field='url_name', template_name='conference_detail.html')),
    ...
    # Disabling .doc invoices for the time being
