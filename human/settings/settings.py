...
DATABASES = {
    'default': {
        ...
        'NAME': 'human',                      # Or path to database file if using sqlite3.
...
# whether want Django to try serving user uploaded media
SERVE_MEDIA = False
...
EMAIL_HOST_USER = os.environ.get('GMAIL_USER', False)
EMAIL_HOST_PASSWORD = os.environ.get('GMAIL_PASSWORD', False)
EMAIL_PORT = 587
